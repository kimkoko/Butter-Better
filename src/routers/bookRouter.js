...
// 상품 삭제 *admin
router.delete('/books/:id', asyncHandler(async (req, res, next) => {
  try {
...
// 상품 수정 *admin
router.patch('/books/:id', asyncHandler(async (req, res, next) => {
  ...
  try {
    const updatedBookInfo = await Book.findByIdAndUpdate(req.params.id, req.body, { new: true, runValidators: true });
